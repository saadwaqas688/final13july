...
a.view:hover, a.view:active {
 ...
 a.view1:link, a.view1:visited {
  background-color: #99ffeb;
  color: black;
  border: 2px solid #99ffeb;
  padding: 10px 20px;
  text-align: center;
  text-decoration: none;
  display: inline-block;
...
<div>
                                ...
                                <table >
										...
										foreach($cat_arr as $list){
											?>
										<tr> 	
											<th><h2><a  class="view1" href="categoriessingle.php?id=<?php echo $list['id']?>"><?php echo $list['categories']?></a></h2></th>
